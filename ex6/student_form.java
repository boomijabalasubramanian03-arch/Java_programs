...
public class StudentForm extends JFrame {
    ...
    public StudentForm() {
        ...
        coursesPanel.add(new JCheckBox("English"));
        coursesPanel.add(new JCheckBox("Mathematics"));
        coursesPanel.add(new JCheckBox("Physics"));
        coursesPanel.add(new JCheckBox("Chemistry"));
        coursesPanel.add(new JCheckBox("Biology"));
        coursesPanel.add(new JCheckBox("Aptitude"));
        coursesPanel.add(new JCheckBox("Creative thinking"));
        gbc.gridx = 1;
        gbc.gridy = 8;
        gbc.gridwidth = 3;
